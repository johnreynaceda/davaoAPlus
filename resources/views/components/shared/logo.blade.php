<div class="flex items-end space-x-2">
    <div class="flex items-end">
        <svg class="w-8 h-8 text-blue-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
            aria-hidden="true">
            <path
        ...
        <h1 class="font-black text-gray-700 uppercase">Davao</h1>
    </div>
    <h1 class="font-black text-lg text-blue-600">A+</h1>
</div>
