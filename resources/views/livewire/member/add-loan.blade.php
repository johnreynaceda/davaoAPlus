<div>
    @if ($loan->count() > 0)
        <div class="grid place-content-center w-full">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="h-96"
                viewBox="0 0 1100.02 811.41" role="img" artist="Katerina Limpitsouni" source="https://undraw.co/">
                <defs>
                    <linearGradient id="785c60ff-874e-47fc-85e9-4f7317d8d736-5" x1="942.13" y1="802.28"
                        x2="942.13" y2="308.24" gradientUnits="userSpaceOnUse">
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#258bf1" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#258bf1" opacity="0.1" />
                <ellipse cx="545.08" cy="739.96" rx="446.98" ry="41.12" fill="#258bf1" opacity="0.1" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="url(#785c60ff-874e-47fc-85e9-4f7317d8d736-5)" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#3f3d56" />
                <g opacity="0.1">
                    <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#fbbebe" />
                <path d="M965.75,551.06s12,11.81,26-3.86L981,535.79H967.4Z" transform="translate(-49.99 -44.29)"
                    fill="#575a89" />
                <path d="M967.05,535.79l-1.65,15.27s12,11.81,26-3.86" transform="translate(-49.99 -44.29)"
                    opacity="0.1" />
                <path
                    d="M987.24,537.87s4.83,12.67,8.33,16.5,9,30.33,1.67,27.33-21.33-25.33-22.17-29.16-1.16-14.67-1.16-14.67Z"
                    transform="translate(-49.99 -44.29)" fill="#fbbebe" />
                <polygon points="832.42 558.58 897.08 561.08 889.58 533.74 857.01 533.08 832.42 558.58"
                    fill="#575a89" />
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#575a89" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M952,802.24c-2.91.11-19.45,0-19.45,0a9,9,0,0,1-.68-.8C936.08,800,945.22,797.84,952,802.24Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M891.4,495.23c-.07.35-1.28,5.67-3.12,13.88C889,502.1,890,497.07,891.4,495.23Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M932,492.59s14.17,89-27.79,100C904.2,592.55,933.24,588.14,932,492.59Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M953,613.46a55.48,55.48,0,0,1-7.39-.23L934.29,491.54C941.51,496.26,950.15,582.62,953,613.46Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#3f3d56" />
                <path d="M876.74,398.2s1.17,9.34-2.83,11.67S876.74,398.2,876.74,398.2Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M961.57,470.54s9.5-14,10.84-10S961.57,470.54,961.57,470.54Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M962.24,475.2s9.37-11.5,10.27-7S962.24,475.2,962.24,475.2Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#3f3d56" />
                <path d="M931.75,395.83s14.07.9,14.16,2.9S931.75,395.83,931.75,395.83Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M897.57,387.3s-14.07.9-14.16,2.9S897.57,387.3,897.57,387.3Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M878.81,389.19h0l-1.29,2-3.29-1.75,1.73-2.66A7.25,7.25,0,0,1,878.81,389.19Z"
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M857.91,463.2s2.93-13.78-1-18.16-2.67-27.34,3.33-26.84,15,18.66,13.5,22.5-7.17,23.5-7.17,23.5Z"
                    transform="translate(-49.99 -44.29)" fill="#fbbebe" />
                <path
                ...
                <circle cx="518.99" cy="454.79" r="308.5" fill="#258bf1" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#444053" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#f6f8fb" />
                <path d="M407.11,281.31s-92.93,59.41-92.17,152.34S407.11,281.31,407.11,281.31Z"
                    transform="translate(-49.99 -44.29)" opacity="0.05" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#258bf1" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#258bf1" />
                <ellipse cx="1073.09" cy="725.46" rx="26.93" ry="4.55" fill="#258bf1"
                    opacity="0.1" />
                <ellipse cx="46.77" cy="801.15" rx="26.93" ry="4.55" fill="#258bf1"
                    opacity="0.1" />
                <ellipse cx="203.1" cy="806.86" rx="26.93" ry="4.55" fill="#258bf1"
                    opacity="0.1" />
                <ellipse cx="1014.15" cy="774.22" rx="40.21" ry="6.8" fill="#258bf1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#ffd037" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" opacity="0.1" />
                <path d="M70.1,732.7c0,2.53.28,4.58.63,4.58s.63-2,.63-4.58-.35-1.34-.7-1.34S70.1,730.17,70.1,732.7Z"
                    transform="translate(-49.99 -44.29)" fill="#ffd037" />
                <path
                ...
                <path
                    ...
                    transform="translate(-49.99 -44.29)" fill="#a8a8a8" />
                <path
                    ...
                    transform="translate(-49.99 -44.29)" opacity="0.2" />
                <path
            ...
            <p class="text-xl text-gray-500">
                You still have outstanding loan payments. This feature will be available once all payments are
                completed.
            </p>
        </div>
    @else
        ...
        <div class="mt-5">
            ...
            <div class="mt-5">
                <x-button label="Submit Form" blue squared right-icon="arrow-right" wire:click="submitForm"
                    spinner="submitForm" />
                <p class="text-sm text-gray-500">by clicking this button, you autorized and confirm that the
                    information
                    contained are true
                    anf correct.
                </p>
